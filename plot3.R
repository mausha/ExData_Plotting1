###############################################################################
# This is an R script that creates the third plot (plot3.png) 
# required for the Coursera Exploratory Data Analysis course, 
# week-1 assignment:
#     - 3 line plots of Date + Time (x-axis) vs Submetering (y-axis)
#         - One line for each of Sub_metering_1, Sub_metering_2, and Sub_metering_3
#     - X label: none
#     - Y label: (black) Energy sub metering
#     - Title: none
