###############################################################################
# This is an R script that creates the second plot (plot2.png) 
# required for the Coursera Exploratory Data Analysis course, 
# week-1 assignment:
#     - A line plot of Date + Time (x-axis) vs Global_active_power (y-axis)
#     - X label: none
#     - Y label: (black) Global Active Power (kilowatts)
#     - Title: none
###############################################################################
